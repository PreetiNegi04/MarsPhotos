...
class PhotoGridAdapter():ListAdapter<MarsPhoto, PhotoGridAdapter.MarsPhotoHolder>(DiffCallBack) {
    class MarsPhotoHolder(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MarsPhotoHolder {
        return MarsPhotoHolder(GridViewItemBinding.inflate(LayoutInflater.from(parent.context)))
    }
